    ...
    <Card className="w-full max-w-md mx-auto">
      <CardContent className="p-8">
        <div className="text-center space-y-6">
          <div>
            <p className="text-sm text-gray-500 mb-2">Náhuatl</p>
            <h2 className="text-4xl font-bold text-tierra mb-3">{palabra.nahuatl}</h2>
          ...
          {isFlipped && (
            <div className="pt-4 border-t border-gray-200 animate-in fade-in duration-200">
              <p className="text-sm text-gray-500 mb-2">Español</p>
              <p className="text-2xl font-semibold text-obsidiana">{palabra.espanol}</p>
              {palabra.ejemplo && (
                <p className="text-sm text-gray-600 italic mt-3">"{palabra.ejemplo}"</p>
              )}
              {palabra.categoria && (
                <p className="text-xs text-gray-500 mt-2">Categoría: {palabra.categoria}</p>
              )}
            </div>
          )}
